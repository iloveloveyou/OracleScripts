...
ADD DATABASE '$STANDBY_DB_ALIAS' AS CONNECT IDENTIFIER IS '$STANDBY_DB_ALIAS' MAINTAINED AS PHYSICAL;
EDIT DATABASE '$PRIMARY_DB_ALIAS' SET PROPERTY 'LogXptMode'='SYNC';
EDIT DATABASE '$STANDBY_DB_ALIAS' SET PROPERTY 'LogXptMode'='SYNC';
EDIT DATABASE '$PRIMARY_DB_ALIAS' SET PROPERTY 'StandbyArchiveLocation'='$STANDBY_ARCHLOGS_LOCATION';
EDIT DATABASE '$STANDBY_DB_ALIAS' SET PROPERTY 'StandbyArchiveLocation'='$STANDBY_ARCHLOGS_LOCATION';
EDIT CONFIGURATION SET PROPERTY FastStartFailoverThreshold = $SWITCH_TRHESHOLD_SECONDS;
